...
export interface UserProps extends Modify<UserParams, {
  direccion: any; 
...
export class User {
  ...
  initWithParams(params: UserParams) {
  ...
  get userSelected(){return this._props.userSelected;}
  set userSelected(value){this._props.userSelected=value}
  get gimnasio() { 
  ...
  initEmpty() {
    ...
    this._props.userSelected=false;
    this._props.sucursal=[];
  }
